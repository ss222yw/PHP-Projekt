<?php
	...
	echo "<div class='container-fluid'><h1>NybroHH fastigheter</h1></div>";
	// Run Application
	...
	echo '<div class="container-fluid">'.$date.'<br>&copy;Sahib Sahib ss222yw UD13 <a href="http://www.lnu.se/" target="_blank">LNU</a></div>';	
